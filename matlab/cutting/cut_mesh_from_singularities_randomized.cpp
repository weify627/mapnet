...
#include "cut_mesh_from_singularities_randomized.h"
...
public:
    ...
    inline MeshCutter_randomized(const Eigen::PlainObjectBase<DerivedV> &V_,
...
typename DerivedM,
typename DerivedO>
void cut_mesh_from_singularities_randomized(const Eigen::PlainObjectBase<DerivedV> &V,
                                            const Eigen::PlainObjectBase<DerivedF> &F,
                                            const Eigen::PlainObjectBase<DerivedM> &Handle_MMatch,
                                            Eigen::PlainObjectBase<DerivedO> &Handle_Seams)
{
    MeshCutter_randomized< DerivedV, DerivedF, DerivedM, DerivedO> mc(V, F, Handle_MMatch);
    mc.cut(Handle_Seams);
    
}


template void cut_mesh_from_singularities_randomized<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
Eigen::Matrix<int, -1, -1, 0, -1, -1>, Eigen::Matrix<double, -1, -1, 0, -1, -1>,
Eigen::Matrix<int, -1, -1, 0, -1, -1> >(Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1,
                                        0, -1, -1> > const&, Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1> > const&,
