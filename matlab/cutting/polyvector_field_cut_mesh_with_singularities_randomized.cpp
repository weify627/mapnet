                                                             ...
                                                             Eigen::PlainObjectBase<DerivedC> &cuts)
{
    ...
    cut_mesh_from_singularities_randomized(V, F, Eigen::MatrixXd::Zero(F.rows(), 3).eval(), cuts);
                                                             ...
                                                             Eigen::PlainObjectBase<DerivedC> &cuts)
{
    ...
    polyvector_field_cut_mesh_with_singularities_randomized(V, F, VF, VV, TT, TTi, singularities, cuts);
    
    
}

template void polyvector_field_cut_mesh_with_singularities_randomized<Eigen::Matrix<double, -1, -1,
0, -1, -1>, Eigen::Matrix<int, -1, -1, 0, -1, -1>, Eigen::Matrix<int, -1, -1, 0, -1, -1>,
